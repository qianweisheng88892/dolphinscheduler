...
//
//public final class ConsulRegistrybak implements Registry {
//
//   private static final Logger log = LoggerFactory.getLogger(ConsulRegistrybak.class);
...
//   }
//
//   public ConsulRegistrybak(ConsulRegistryProperties prop) {
...
//      consulProperties.setUrl("http://127.0.0.1:8500");
//
//      ConsulClient cc = new ConsulClientImpl(consulProperties);
//      String session = cc.getSession(SessionRequest.builder().name("consul_registry_session")
